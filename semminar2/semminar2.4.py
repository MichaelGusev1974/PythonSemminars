...
a = input('скопируйте строку: ')                  # Копируем строку из условия задачи в консоль
b = (len(a)*60)//100                              # получаем количество рублей
c = (len(a)*60)-b*100                             # получаем количество копеек
print(f'Стоимость текста: {b}, p., {c}, коп.')
